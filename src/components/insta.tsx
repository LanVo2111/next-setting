...
import { InstaImgType } from '@/types'

import { useGetInstaImageQuery } from '@/utils/fetch'
import styles from '../styles/cart.module.scss'
import { Loading } from './loading'

export const Insta = () => {
  const { data: instaImg, isLoading } = useGetInstaImageQuery('insta')
  return (
    <div className={styles.insta}>
      <div className='inner inner'>
        <h2 className={styles['insta_title']}>Follow us on Instagram</h2>
        <div className={styles.gallery}>
          {instaImg?.map((img: InstaImgType) => (
            <figure key={img.id}>
              <Link href={img.link}>
                <Image src={`http://localhost:3010/${img.pathImg}`} alt='instagram' className='insta-image' width={260} height={260} priority/>
